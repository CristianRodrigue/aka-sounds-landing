...
export const products = [
    {
        ...
        previewTracks: [
            ...
            { id: 5, name: "LD - Afterlife", type: "Lead", duration: "0:04", url: "/samples/LD - Afterlife.mp3" },
            { id: 6, name: "SCR - Broken Drill", type: "Screech", duration: "0:03", url: "/samples/SCR - Broken Drill.mp3" },
            { id: 8, name: "DEAT_AKA_VOCAL_WET_01", type: "Vocal Wet", duration: "0:04", url: "/samples/AKA_SOUNDS_HARDTECHNO-ESSENTIALS-VOL.-1-FREE-TRIAL/03 Vocals & FX/02 Vocals - Wet (Processed)/DEAT_AKA_VOCAL_WET_01.wav" }
        ],
        testimonials: [
    ...
    },
    {
        ...
        previewTracks: [
            ...
            { id: 6, name: "DEAT_AKA_VOCAL_WET_01", type: "Vocal Wet", duration: "0:04", url: "/samples/AKA_SOUNDS_HARDTECHNO-ESSENTIALS-VOL.-1-FREE-TRIAL/03 Vocals & FX/02 Vocals - Wet (Processed)/DEAT_AKA_VOCAL_WET_01.wav" }
        ],
        testimonials: [
            { id: 1, text: "High quality pack... I got inspired by it!", author: "Kimmo Korpela", role: "G-Powered (Finland)", initials: "KK" },
            { id: 2, text: "Ahhhhh!!!!!!!! thats very sickkkk keep it upppp", author: "@MFB5", role: "YouTube Subscriber", initials: "M" },
